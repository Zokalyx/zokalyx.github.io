<script lang="ts">
	import show from '$lib/assets/show.jpg';
	import song from '$lib/assets/midnight daydream.mp3';
...
<LinkIcon
	...
	alt="Youtube icon"
	url="https://www.youtube.com/@franr."
	text="/@franr."
	color="#FF0000"
	height="3.5em"
/>
<AudioPlayer src={song} text="midnight_daydream.mp3" />
